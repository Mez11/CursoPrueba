 ...
 * @see com.cu.hbm.model.Usuario
 * @author Hibernate Tools
 */
public class UsuarioHome {
	private static final Logger log = LoggerFactory.getLogger( UsuarioHome.class );
	...
	public Usuario findById(int id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("com.cu.hbm.model.Usuario", id);
			if (instance == null) {
	...
	public List findByExample(Usuario instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.cu.hbm.model.Usuario")
